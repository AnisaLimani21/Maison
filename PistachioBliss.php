...
<section class="product-single"
         data-name="Pistachio Bliss"
         data-price="3.50"
         data-img="Screenshot__419_-removebg-preview.png">

    <div class="circle-box">
        <img src="img/Screenshot__419_-removebg-preview.png" alt="Pistachio Bliss" style="width:500px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Pistachio Bliss</h2>
