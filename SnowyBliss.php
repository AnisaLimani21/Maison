...
<section class="product-single">
    ...
    <div class="product-details">
        ...
        <h3>Ingredients:</h3>
        <ul>
            <?php foreach(explode(',', $product['ingredients'] ?? 'Soft Vanilla Batter,Powdered Sugar,White Chocolate Chips,Butter,Milk,Whipped Cream') as $ing) echo "<li>".htmlspecialchars(trim($ing))."</li>"; ?>
        </ul>
        <form id="addCartForm">
