...
<section class="product-single"
         data-name="Snowy Bliss"
         data-price="3.00"
         data-img="Screenshot__405_-removebg-preview.png">

    <div class="circle-box">
        <img src="img/Screenshot__405_-removebg-preview.png" alt="Snowy Bliss" style="width:400px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Snowy Bliss</h2>
