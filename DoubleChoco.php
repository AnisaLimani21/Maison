...
<title>Double Chocolate Muffin</title>
...
<section class="product-single">
    <div class="circle-box">
        <img src="img/Screenshot (412).png" alt="Double Chocolate Muffin">
    </div>
    <div class="product-details">
        <h2 class="product-title">Double Chocolate Muffin</h2>
        <p class="price">$3.20</p>
        <h3>Ingredients:</h3>
        <ul>
            <li>Rich Cocoa Powder</li>
