...
<section class="product-single"
         data-name="Chocolate Frosted"
         data-price="2.50"
         data-img="Screenshot__397_-removebg-preview.png">
    <div class="circle-box">
        <img src="img/Screenshot__397_-removebg-preview.png" alt="Chocolate Frosted" style="width:500px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Chocolate Frosted</h2>
        <p class="price">$2.50</p>
        <h3>Ingredients:</h3>
        <ul>
            <li>Soft Chocolate Batter</li>
            <li>Cocoa Powder</li>
