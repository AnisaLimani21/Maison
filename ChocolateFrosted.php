...
$product_name = "Chocolate Frosted";
...
<section class="product-single">
    ...
    <div class="product-details">
        ...
        <h3>Ingredients:</h3>
        <ul>
            <?php foreach(explode(',', $product['ingredients'] ?? 'Soft Chocolate Batter,Cocoa Powder,Dark Chocolate Chips,Butter,Sugar,Fresh Cream') as $ing) echo "<li>".htmlspecialchars(trim($ing))."</li>"; ?>
        </ul>
