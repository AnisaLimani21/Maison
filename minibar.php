...
<title>Mini Bar Gift Box Size L</title>
...
<section class="product-single">
    <div class="circle-box">
        <img src="img/dhurata1.webp" alt="Mini Bar Gift Box">
    </div>
    <div class="product-details">
        <h2 class="product-title">Mini Bar Gift Box Size L</h2>
        ...
        <p class="total-price">Total: €42.00</p>
...
document.getElementById('add-to-cart').onclick = () => {
    let qty = parseInt(quantityInput.value);
    let existing = cart.find(item => item.name === "Mini Bar Gift Box Size L");
    if(existing){ existing.qty += qty; } 
    else{ cart.push({name:"Mini Bar Gift Box Size L", pricePerUnit: price, qty: qty, img:"dhurata1.webp"}); }
