...
<title>Dark Velvet Cookie</title>
...
<section class="product-single">
    <div class="circle-box">
        <img src="img/Crumbled_Chocolate_Cookie_Delight__1_-removebg-preview.png" alt="Dark Velvet Cookie">
    </div>

    <div class="product-details">
        <h2 class="product-title">Dark Velvet Cookie</h2>
        <p class="price">$3.50</p>
        <p class="description">
            Rich, dark cocoa cookie with bold coffee notes and smooth chocolate chunks. Deep, intense flavor.
        </p>

        <h3>Ingredients:</h3>
        <ul>
            <li>Dark cocoa powder</li>
            <li>Espresso / coffee flavor</li>
