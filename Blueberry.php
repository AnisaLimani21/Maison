...
<title>Blueberry Burst Muffin</title>
...
<section class="product-single">
    <div class="circle-box">
        <img src="img/Screenshot (411).png" alt="Blueberry Burst Muffin">
    </div>
    <div class="product-details">
        <h2 class="product-title">Blueberry Burst Muffin</h2>
        ...
        <p class="total-price">Total: $2.80</p>
