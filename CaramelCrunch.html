...
<section class="product-single" 
         data-name="Caramel Crunch" 
         data-price="3.00" 
         data-img="Screenshot__400_-removebg-preview.png">
    <div class="circle-box">
        <img src="img/Screenshot__400_-removebg-preview.png" alt="Caramel Crunch">
    </div>
    <div class="product-details">
        <h2 class="product-title">Caramel Crunch</h2>
