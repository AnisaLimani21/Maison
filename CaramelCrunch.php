...
<section class="product-single">
    ...
    <div class="product-details">
        ...
        <h3>Ingredients:</h3>
        <ul>
            <?php foreach(explode(',', $product['ingredients'] ?? 'Soft Vanilla Batter,Caramel Sauce,Brown Sugar,Butter,Chopped Nuts,Sea Salt') as $ing) echo "<li>".htmlspecialchars(trim($ing))."</li>"; ?>
        </ul>
