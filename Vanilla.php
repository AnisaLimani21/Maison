...
<title>Vanilla Dream Muffin</title>
...
<section class="product-single">
    <div class="circle-box">
        <img src="img/vanilla-dream-irresistible-vanilla-muffin-white-table_351987-1858.jpg" alt="Vanilla Dream Muffin">
    </div>
    <div class="product-details">
        <h2 class="product-title">Vanilla Dream Muffin</h2>
