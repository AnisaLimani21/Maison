...
$product_name = "Golden Nut Pistachio";
...
<section class="product-single">
    ...
    <div class="product-details">
        ...
        <h3>Ingredients:</h3>
        <ul>
            <?php foreach(explode(',', $product['ingredients'] ?? 'Soft Vanilla Batter,Crushed Pistachios,Mixed Nuts,White Chocolate Drizzle,Butter,Honey') as $ing) echo "<li>".htmlspecialchars(trim($ing))."</li>"; ?>
        </ul>
        <form id="addCartForm">
