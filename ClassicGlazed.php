...
<section class="product-single"
         data-name="Classic Glazed"
         data-price="2.00"
         data-img="Glazed-Donuts--removebg-preview.png">

    <div class="circle-box">
        <img src="img/Glazed-Donuts--removebg-preview.png" alt="Classic Glazed" style="width:500px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Classic Glazed</h2>
        ...
        <p class="total-price">Total: $2.00</p>
