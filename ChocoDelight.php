...
<section class="product-single"
         data-name="Choco Delight"
         data-price="3.20"
         data-img="Screenshot__423_-removebg-preview.png">

    <div class="circle-box">
        <img src="img/Screenshot__423_-removebg-preview.png" alt="Choco Delight" style="width:500px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Choco Delight</h2>
        ...
        <p class="total-price">Total: $3.20</p>
