...
<section class="product-single"
         data-name="Vanilla Cloud"
         data-price="3.00"
         data-img="Screenshot__422_-removebg-preview.png">

    <div class="circle-box">
        <img src="img/Screenshot__422_-removebg-preview.png" alt="Vanilla Cloud" style="width:500px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Vanilla Cloud</h2>
