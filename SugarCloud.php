...
<section class="product-single"
         data-name="Sugar Cloud"
         data-price="2.50"
         data-img="Screenshot__403_-removebg-preview.png">

    <div class="circle-box">
        <img src="img/Screenshot__403_-removebg-preview.png" alt="Sugar Cloud" style="width:450px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Sugar Cloud</h2>
        <p class="price">$2.50</p>

        <h3>Ingredients:</h3>
        <ul>
            <li>Soft Vanilla Batter</li>
            <li>Bueno Chocolate Pieces</li>
            <li>Milk Chocolate Drizzle</li>
            <li>Butter</li>
            <li>Sugar</li>
            <li>Whipped Cream</li>
        </ul>
        ...
        <p class="total-price">Total: $2.50</p>
...
const productTitle = productSingle.dataset.name;
const productPrice = parseFloat(productSingle.dataset.price);
const productImg = productSingle.dataset.img;
...
addToCartBtn.addEventListener("click", () => {
    ...
    const product = { name: productTitle, pricePerUnit: productPrice, img: productImg, qty: quantity };
    cart.push(product);
