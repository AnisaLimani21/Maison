...
<section class="product-single">
    ...
    <div class="product-details">
        ...
        <h3>Ingredients:</h3>
        <ul>
            <?php foreach(explode(',', $product['ingredients'] ?? 'Soft Vanilla Batter,Bueno Chocolate Pieces,Milk Chocolate Drizzle,Butter,Sugar,Whipped Cream') as $ing) echo "<li>".htmlspecialchars(trim($ing))."</li>"; ?>
        </ul>
        <form id="addCartForm">
