...
<section class="product-single">
    ...
    <div class="product-details">
        ...
        <h3>Ingredients:</h3>
        <ul>
            <?php foreach(explode(',', $product['ingredients'] ?? 'Fresh Blueberries,Soft Vanilla Batter,Brown Sugar,Butter,Eggs,A Touch of Lemon') as $ing) echo "<li>".htmlspecialchars(trim($ing))."</li>"; ?>
        </ul>
