...
<section class="product-single" 
         data-name="Blueberry Bliss" 
         data-price="2.00" 
         data-img="Screenshot__402_-removebg-preview.png">
    <div class="circle-box">
        <img src="img/Screenshot__402_-removebg-preview.png" alt="Blueberry Bliss">
    </div>

    <div class="product-details">
        <h2 class="product-title">Blueberry Bliss</h2>
