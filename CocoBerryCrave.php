...
<title>Coco Berry Crave Cookie</title>
...
<section class="product-single">
    <div class="circle-box">
        <img src="img/Broken_Oatmeal_Raisin_Cookie_in_Air__1_-removebg-preview (1).png" alt="Coco Berry Crave Cookie">
    </div>

    <div class="product-details">
        <h2 class="product-title">Coco Berry Crave Cookie</h2>
        <p class="price">$3.00</p>
        <p class="description">
            A fruity chocolate cookie filled with cranberry pieces and oat crunch. Sweet, tangy, and unique.
        </p>
