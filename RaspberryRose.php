...
<section class="product-single"
         data-name="Raspberry Rose"
         data-price="3.40"
         data-img="Screenshot__424_-removebg-preview.png">

    <div class="circle-box">
        <img src="img/Screenshot__424_-removebg-preview.png" alt="Raspberry Rose" style="width:500px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Raspberry Rose</h2>
        ...
        <p class="total-price">Total: $3.40</p>
