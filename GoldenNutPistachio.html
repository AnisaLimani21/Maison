...
<title>Golden Nut Pistachio</title>
...
<section class="product-single"
         data-name="Golden Nut Pistachio"
         data-price="3.50"
         data-img="Screenshot__414_-removebg-preview.png">

    <div class="circle-box">
        <img src="img/Screenshot__414_-removebg-preview.png" alt="Golden Nut Pistachio" style="width:500px; max-width:100%;">
    </div>

    <div class="product-details">
        <h2 class="product-title">Golden Nut Pistachio</h2>
        ...
        <p class="total-price">Total: $3.50</p>
