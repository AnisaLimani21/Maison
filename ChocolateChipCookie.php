...
<section class="product-single">
    <div class="circle-box">
        <img src="img/Cookie_in_Mid-Break_with_Chocolate_Chips__1_-removebg-preview.png" alt="Chocolate Chip Cookie">
    </div>

    <div class="product-details">
        <h2 class="product-title">Chocolate Chip Cookie</h2>
        <p class="price" data-unit-price="2.50">$2.50</p>
        <p class="description">
            Soft, chewy cookies loaded with chocolate chips. Perfect for any sweet tooth!
        </p>
